  ...
  list = _require.list;
{
  ...
  var item;
  (function () {
    var createTable = function createTable(music, page, step) {
      // 一度リストを空にする
      while (table.rows[1]) {
        table.deleteRow(1);
      }
      ...
      music.forEach(function (e, i) {
        ...
        var id = e['id'].split('/');
        var idText = id.slice(-1)[0].replace("mp3", "");
        // const idText = e["id"]
    ...
    var step = 20; // ステップ数（1ページに表示する項目数）

    var musiclist = music;
    var form = document.getElementById('form-music-search');
    form.onsubmit = function () {
      return false;
    };
    table = document.getElementById('music-table');
    createTable(music, page, step);
    var _iterator = _createForOfIteratorHelper(document.getElementById('page').children),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        item.addEventListener("click", function fn() {
          ...
          var _iterator3 = _createForOfIteratorHelper(document.getElementById('page').children),
            _step3;
          try {
    ...
    document.getElementById("button").onclick = function () {
      ...
      var type = document.getElementById("search-select").value;
      musiclist = music;
      console.log(type);
      switch (type) {
        case 'Free':
          musiclist = music.filter(function (e) {
            if (e['id'].indexOf('/root/sim/music/out') == -1) {
              return true;
            }
          });
      ...
      musiclist = musiclist.filter(function (e) {
        if (e["id"].indexOf(text) != -1) {
          return true;
        }
      });
      var i = 1;
      var _iterator2 = _createForOfIteratorHelper(document.getElementById('page').children),
        _step2;
      try {
